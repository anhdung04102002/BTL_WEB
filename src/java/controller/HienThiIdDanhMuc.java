 ...
 */
@WebServlet(name = "HienThiIdDanhMuc", urlPatterns = {"/iddanhmuc"})
public class HienThiIdDanhMuc extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("views/admin/UpdateC.jsp").forward(request, response);
             } catch (Exception e) {
