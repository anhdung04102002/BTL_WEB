 ...
 */
@WebServlet(name = "XoaDanhMuc", urlPatterns = {"/xoadanhmuc"})
public class XoaDanhMuc extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet XoaDanhMuc</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet XoaDanhMuc at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
