 ...
 */
@WebServlet(name="AdminUpdatePassword", urlPatterns={"/admin/update_password"})
public class AdminUpdatePassword extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminUpdatePassword</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminUpdatePassword at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("/views/admin/update_password.jsp").forward(request, response);
    } 
